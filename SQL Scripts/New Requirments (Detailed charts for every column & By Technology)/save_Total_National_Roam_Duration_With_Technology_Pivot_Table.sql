...
SET @site_National_Roam_Duration_query = '
				SELECT * INTO Total_National_Roam_Duration_With_Technology_Pivot_Table
				FROM 
				(SELECT Site_Code_DWH, Status, ' + @pivot_columns +
				' FROM
                (
                  SELECT Site_Code_DWH, Status, Site_Date, National_Roam_Duration FROM Detailed_Sites_Revenue_With_Technology_Chart
                ) AS tmp_tbl             
                PIVOT
                (
...
if object_ID('Total_National_Roam_Duration_With_Technology_Pivot_Table') IS NOT NULL
	DROP TABLE Total_National_Roam_Duration_With_Technology_Pivot_Table;
